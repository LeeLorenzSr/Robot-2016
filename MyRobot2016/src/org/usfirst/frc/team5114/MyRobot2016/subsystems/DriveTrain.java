...
public class DriveTrain extends Subsystem
{
    ...
    public void halfDrive(Side side, double percentVolt)
    {
    	if (side == Side.right)
    	    rightTalon.set(percentVolt);
    	else
    ...
    public double getGyroValue() { return gyro.getAngle(); }
    public double getAccelX() { return accel.getX(); }
    public double getAccelY() { return accel.getY(); }
    public double getAccelZ() { return accel.getZ(); }
