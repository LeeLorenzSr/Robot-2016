...
// 	}
 	...
 	public static void setCameraFeed(int newCamLocation)
 	{
 		...
 		switch (camLocation)
 		{
 			...
 			case BACK:
 				...
 				break;
 			default:
 				SmartDashboard.putString("Camera", "Unknown");
 		}
 	}
 	...
 	public void setImage()
 	{
 		...
 		{
 			System.out.println("There is no image to get!!!");
 		}
    ...
    public void robotInit()
    {
    	...
    	try
    	{
    		magicBox = new AHRS(SPI.Port.kMXP);
    	}
    ...
    public void teleopPeriodic() {
        ...
        if (SmartDashboard.getBoolean("Reset Displacement", false))
        	magicBox.resetDisplacement();
        
        SmartDashboard.putNumber("Velocity_X", magicBox.getVelocityX());
        SmartDashboard.putNumber("Velocity_Y", magicBox.getVelocityY());
        SmartDashboard.putNumber("Displacement_X", magicBox.getDisplacementX());
        SmartDashboard.putNumber("Displacement_Y", magicBox.getDisplacementY());
