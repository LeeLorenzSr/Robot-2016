...
*
*/
public class LowGoalShootCmd extends Command {
 ...
 protected void initialize() {
	 System.out.println("Low Goal Shoot Command----------");
//	 Robot.ballIntake.startShoot();
 }
 ...
 protected void end() {
	 System.out.println("\t-Command isFinished returned true, calling stop...");
