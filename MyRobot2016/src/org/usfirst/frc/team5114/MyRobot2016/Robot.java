...
//	}
    ...
    RobotMap.init();
	    ...
	    autoChooser.addDefault("Rough Terrain [Goes Forwards]", new RoughTerrain());
	    ...
	    autoChooser.addObject("Moat [Goes Backwards]", new Moat());
	    autoChooser.addObject("Portcullis [DOES NOTHING]", new Portcullis());
	    autoChooser.addObject("Ramparts [Goes Backwards]", new Ramparts());
	    autoChooser.addObject("Rock Wall [DOES NOTHING]", new RockWall());
	    autoChooser.addObject("Low Bar [Goes Forwards]", new LowBar());
