...
public class OI {
    ...
    public JoystickButton controllerButton7;
    public JoystickButton controllerButton8;
    ...
    public OI() {
        ...
        controllerButton5.whenPressed(new LiftGateCmd());
        controllerButton7 = new JoystickButton(controller, 7);
        controllerButton7.whenPressed(new DropGateCmd());
        controllerButton8 = new JoystickButton(controller, 8);
        controllerButton8.whenPressed(new LowGoalShootCmd());
