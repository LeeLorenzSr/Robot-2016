...
public class OI {
    ...
    public JoystickButton controllerButton1; // [not used]
    public JoystickButton controllerButton2; // winch up
    public JoystickButton controllerButton3; // winch down
    public JoystickButton controllerButton4; // [not used]
    public JoystickButton controllerButton5; // stop shooter
    public JoystickButton controllerButton6; // stop
    public JoystickButton controllerButton7; // low goal shoot
    public JoystickButton controllerButton8; // intake
    
    public JoystickButton controllerButton9; // Front Camera
    public JoystickButton controllerButton10; // Rear Camera
